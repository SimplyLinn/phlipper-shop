...
if (typeof Worker !== 'undefined') {
  serial = new Worker(new URL('./ConnectionWorker/index.ts', import.meta.url));
  Object.assign(window, { serialWorker: serial });
  serial.onmessage = (e) => {
    if (e.data.operation === 'cli output') {
      ...
      try {
        ...
        if (
          ...
          err.message.startsWith('No pending operation')
        ) {
