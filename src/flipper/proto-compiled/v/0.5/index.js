...
export const PB_System = ($root.PB_System = (() => {
  ...
  PB_System.UpdateRequest = (function () {
    ...
    UpdateRequest.prototype.updateFolder = '';
    ...
    UpdateRequest.encode = function encode(message, writer) {
      if (!writer) writer = $Writer.create();
      if (
        message.updateFolder != null &&
        Object.hasOwnProperty.call(message, 'updateFolder')
      )
        writer.uint32(10).string(message.updateFolder);
      return writer;
    };
    ...
    UpdateRequest.decode = function decode(reader, length) {
      ...
      while (reader.pos < end) {
        ...
        switch (tag >>> 3) {
          case 1: {
            message.updateFolder = reader.string();
            break;
          }
          default:
            reader.skipType(tag & 7);
    ...
    UpdateRequest.verify = function verify(message) {
      ...
      if (
        message.updateFolder != null &&
        message.hasOwnProperty('updateFolder')
      )
        if (!$util.isString(message.updateFolder))
          return 'updateFolder: string expected';
      return null;
    };
    ...
    UpdateRequest.fromObject = function fromObject(object) {
      ...
      if (object.updateFolder != null)
        message.updateFolder = String(object.updateFolder);
      return message;
    };
    ...
    UpdateRequest.toObject = function toObject(message, options) {
      if (!options) options = {};
      const object = {};
      if (options.defaults) object.updateFolder = '';
      if (
        message.updateFolder != null &&
        message.hasOwnProperty('updateFolder')
      )
        object.updateFolder = message.updateFolder;
      return object;
    };
